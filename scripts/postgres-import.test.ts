...
const project = (id: string, ownerUserId: string) => ({ project: { id, ownerUserId } as Project, ownerUserId })
const task = (id: string, projectId: string, ownerUserId: string) => ({ task: { id, projectId, ownerUserId } as Task, ownerUserId })
