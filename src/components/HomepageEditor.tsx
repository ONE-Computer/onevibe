...
const unavailable = (message: string) => <section className="homepage-editor-view"><header><div><span className="view-eyebrow">Owner controls</span><h1>Homepage</h1><p>{message}</p></div><FileEdit size={28} /></header><div className="homepage-editor-empty"><ShieldCheck size={20} /><strong>Owner-scoped theme store not configured</strong><span>Configure Postgres and an organization-owner session before editing tenant content.</span></div></section>
