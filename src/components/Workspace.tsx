import { Activity, ArrowLeft, ArrowRight, Check, ClipboardCheck, Code2, Copy, Download, Eye, File, Files, GitFork, Globe2, History, Image, Maximize2, Minimize2, Network, Palette, Pencil, Presentation, RefreshCw, Save, Search, Settings2, ShieldCheck, Table2, TerminalSquare } from 'lucide-react'
