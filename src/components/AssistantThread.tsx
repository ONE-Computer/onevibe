...
const AssistantMessage = () => {
  ...
  return <MessagePrimitive.Root className="aui-assistant-message"><div className="assistant-orb">O</div><div><strong>ONEVibe <small>{running ? '· writing' : `· ${timestamp(createdAt)}`}</small></strong><MessagePrimitive.Parts />{running && <span className="typing-indicator" aria-label="ONEVibe is writing"><i /><i /><i /></span>}</div></MessagePrimitive.Root>
}
