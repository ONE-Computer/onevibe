...
- [ ] **P5-02** Adopt TanStack Query — QueryClient is mounted at the app root; the Skills catalog and runtime-readiness snapshot now use cached queries with bounded retry/stale/error behavior. Remaining collections and mutations stay open until migrated without duplicating SSE/server authority.
