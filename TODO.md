...
- [ ] **P5-02** Adopt TanStack Query — QueryClient is mounted at the app root; Skills, runtime readiness, MCP declarations, Projects, Schedules, Library, and paginated Conversations now use cached queries, with their mutations/cache updates wired where supported. The task/SSE snapshot boundary and remaining task mutations stay open until migrated without duplicating server authority.
