...
- [ ] **P5-02** Adopt TanStack Query — QueryClient is now mounted at the app root and the Skills catalog uses a cached query with explicit stale/error behavior; remaining collections and mutations stay open until migrated without duplicating SSE/server authority.
