...
type SkillPack = { id: TaskSkill; version: 1; title: string; summary: string; content: string }
...
const pack = (id: TaskSkill, title: string, summary: string, body: string): SkillPack => ({
  id, version: 1, title, summary,
  content: `---\nname: ${id}\ndescription: ${title}\nversion: 1\n---\n\n# ${title}\n\n${body.trim()}\n`,
})
