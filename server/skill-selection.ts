...
export const skillSelectionEventFor = (provider: Task['provider'], skills: Task['skills']): EventInput => {
  ...
  return {
    ...
    payload: { skills: skillPackManifestFor(skills), permissionChange: false, materialization: simulated ? 'not_executed_demo' : 'adapter_owned' },
  }
}
