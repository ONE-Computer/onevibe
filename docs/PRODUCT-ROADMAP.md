...
3. **See and verify the work:** managed cloud browser, previews, build/a11y/visual checks, citations, replayable evidence, and honest runtime labels.
...
|---|---|---|---|
| 1–14 | Task/agent loop, planning, steering, timing, waiting, routes, history | R1.1; maintain 1–2, 6, 8–14 | Rows 3–5 and 7 close with agent plans, elapsed time, reset, and mid-run steering |
...
| 61–70 | Embedded workspace | R1.1, R2.1 | Syntax highlighting plus Dashboard/Database/Settings with project permissions |
...
| 91–100 | Validation, publish/handoff, export/reuse, cross-device | R1.3, R2.2–R2.4, R3.1–R3.4 | Universal build/a11y/browser validation; governed deploy/GitHub; PDF/drive; full deck UX; mobile clients |
