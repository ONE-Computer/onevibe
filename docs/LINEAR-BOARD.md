...
- The focused local gate is green: `npm run check` (lint, 43 files / 224 tests, production build, and all E2E harness typechecks). Boundary: host-process local proof only; no microVM/ONEComputer/OpenVTC/production egress claim.
