...
3. Browser-check the inline plan/execution composition at desktop and 390px mobile widths, then add golden flows for new task → streaming → artifact → follow-up → reload → search.
