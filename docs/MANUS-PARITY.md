...
3. **P** Automatic multi-step planning — five persisted, outcome-aware stages exist. Native Claude SDK tasks may refine their human-readable titles through a validated, evidence-recorded server MCP tool before workspace work; arbitrary stage creation/reordering and equivalent ONEComputer-runtime planning remain pending.
